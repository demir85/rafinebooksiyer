...
namespace Eticaret12.Controllers
{
	...
	public class CheckOutController : Controller
	{
		...
		//		//tek kayıt var ekle
				...
				orderDetail.UnitPrıce = album.Fiyat;
		...
		//	//toplam alışveriş tutarı karttaki limitten az ise alışveriş gerçekleşecek, değilse hata
			var dbdenGelen = _context.CreditCarts.Where(satir => satir.AdSoyad == adsoyad && satir.KartNumarasi 
			== kartNumarasi && satir.SonKullanma == sonkullanma && satir.CVV == cvv).FirstOrDefault();
