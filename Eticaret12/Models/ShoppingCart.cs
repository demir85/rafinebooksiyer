...
namespace Eticaret12.Models
{
    public partial class ShoppingCart
    {
        ...
        } //veritabanı baglantısı için.entity framework aracılıgı ile dbye baglanmak istediğimizde context yapısını kullanırız.
...
//        //kişi daha önce eklemek istediği ürünü sepetine eklemişse ,adet bilgisini artıran, hiç eklememişse 0dan o anki ürünün bilgilerini cart tablosuna kaydeden metot.
       ...
       {
           Album album1=_context.Albums.Where(satir => satir.AlbumId == album.AlbumId).FirstOrDefault();
